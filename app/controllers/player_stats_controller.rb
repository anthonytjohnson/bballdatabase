class PlayerStatsController < ApplicationController
  ...
  private
    ...
    def player_stat_params
      params.require(:player_stat).permit(:player_id, :team_id, :year, :league, :games, :games_started, :minutes, :field_goals, :field_goals_attempted, :three_point, :three_point_attempted, :free_throws, :field_throws_attempted, :off_rebounds, :def_rebounds, :assists, :steals, :blocks, :turnovers, :personal_fouls)
    end
end
